...
export function AnnotationToolbar({
  ...
  // On exam pages, the ClassToolbar (id="class-toolbar") at the top owns
  // class+student selection; hide the duplicate audience selector here.
  // Default false on non-exam pages.
    ...
    >
      ...
      <div className="bg-background/95 backdrop-blur border border-border rounded-lg shadow-lg p-2 flex items-center gap-1">
        ...
        {/* Audience selection + per-broadcast management (Public/class/student
            ...
            in the sidebar. The floating bar holds only drawing tools and the
            personal "my annotations" toggle now. */}
