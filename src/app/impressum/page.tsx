    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <p className="text-muted-foreground mb-8">
          Eduskript is operated by Luz Media GmbH, based in Zürich,
          Switzerland.
        </p>
        ...
        <div className="prose prose-neutral dark:prose-invert space-y-6">
          ...
          <section>
            ...
            <p>
              The content on this website is prepared with care. However,
              Luz Media GmbH makes no warranty as to the accuracy,
              completeness, or timeliness of the information provided.
            </p>
            <p>
              Liability claims against Luz Media GmbH for damages of a
              material or immaterial nature arising from the use or non-use
              of the information provided are excluded, unless caused by
          ...
          <section>
            ...
            <p>
              ...
              Luz Media GmbH has no control over and assumes no responsibility
              for the content of external sites. Access to and use of such
          ...
          <section>
            ...
            <p>
              Teachers retain copyright ownership of their content.
              By publishing on the Platform, they license it under{' '}
              <a
              ...
              , meaning others may copy and adapt it for non-commercial
              purposes with attribution. See our{' '}
          ...
          <section>
            ...
            <p>
              Information on how we handle personal data can be found in
              our{' '}
              <Link href="/terms" className="underline">
                Terms of Service
              </Link>
