...
// Nested under the root layout in ../layout.tsx (which renders <html lang>).
// Split so that notFound() thrown here (unknown slug, reserved prefix) lands
// in the ../not-found.tsx boundary inside the root layout instead of escaping
// the root layout, which would make Next fall back to its bare client-rendered
// error shell.
//
